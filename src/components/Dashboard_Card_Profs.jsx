...
export default function Dashboard_Card_Profs() {
    ...
    const  handleCadastrarProfessor = async (e) => {
        ...
        setTurnoEND('');
        setTurnoINI('');
        let resp = await fetchData("/professor", "POST", {"nome": nome, "senha": senha, "email": email, "cargo": "professor", "end_turno" : turnoEND, "start_turno":turnoINI, "dias_da_semana": dias})
        console.log(resp)
                        ...
                        <div key={index} className={`${css.campo3} ${expandedIndex === index ? css.expanded : ''}`}>
                            ...
                            <div className={css.separa_nome}>
                                ...
                                <button
                                    ...
                                    // onClick={() => handleExcluirProfessor(index)}
                                >
